...
namespace listx
{
	...
	void Object::scan()
	{
		...
		while (e != NULL)
		{
			std::cout << "Êëþ÷: " << ((AAA*)e->data)->key << "; " << "Ñëîâî: " << ((AAA*)e->data)->mas << ";\t";        //Ïîî÷åð¸äíûé âûâîä ýëåìåíòîâ ñïèñêà. Ñïèñîê - ýòî îòäåëüíûé ýëåìåíò òàáëèöû
	...
	void Object::scan1(void* data)
	{
		...
		while (e != NULL)
		{
			...
			{
				std::cout << "Êëþ÷: " << ((AAA*)e->data)->key << "; " << "Ñëîâî: " << ((AAA*)e->data)->mas << ";\t" << std::endl;        //Ïîî÷åð¸äíûé âûâîä ýëåìåíòîâ ñïèñêà. Ñïèñîê - ýòî îòäåëüíûé ýëåìåíò òàáëèöû
			}
			e = e->getNext();
		};
	}
