// zd5.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
void menu(void)  //Вывод меню 
{
    ...
    cout << " 3 - Вычисление суммa положительных двухзначных элементов " << endl;
    cout << " 4 - Выход" << endl;
