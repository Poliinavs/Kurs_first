// osn.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//var10
...
//h(key, i) = (h1(key) + i∙h2(key)) %  hashTableSize, где  h1(key) = key % hashTableSize, h2(key) = 1 + (key % hashTableSize).
