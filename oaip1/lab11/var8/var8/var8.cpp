// var8.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
	...
	for (;;)
	{
		...
		cout << "4 -	удаление элемента c наибольшей суммой\n";
		cout << "5 -	вывод дерева\n";
