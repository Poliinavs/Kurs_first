// var10.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
//
...
int main()
{
	...
	for (;;)
	{
		...
		cout << "5 -	вывод дерева\n";
		cout << "6-       суммa значений всех вершин дерева\n";
		...
		case 6: cout << "Сумма вершин дерева: " << sum<<endl; break;
